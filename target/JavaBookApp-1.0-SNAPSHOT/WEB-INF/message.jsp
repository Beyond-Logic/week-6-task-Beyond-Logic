...
<%@include file="header.jsp" %>
    ...
    <div class="container">
        <div class="welcome shadow p-3 mb-5 bg-body rounded">
        ...
        %>
            ...
            <div class="row">
                ...
                <div class="col-lg-10" style="cursor: pointer;" onclick="window.location.href='view-message?id=<%= messages.get(i).getTo_user() %>'">
